...
class MainStudPage extends Component {
  ...
  handleShowModalEdit = (indexToEdit) => {
    ...
    let selectedStudent = this.state.users[indexToEdit];
    console.log("selected student", selectedStudent);

    this.setState({
      editUsers: selectedStudent,
      showModalEdit: true,
    });
  };
  ...
  handleUpdate = ()=>{
    ...
    usersList[this.state.editUsers.userId] = this.state.editUsers;
            ...
            <Modal.Body>
              ...
              <Row className="mb-3">
                ...
                <Form.Group as={Col} controlId="formGridPassword">
                  ...
                  />
                  {!isValid && (
                    <span className="error">{errorMsgPassword}</span>
                  )}
                </Form.Group>
              </Row>
                    ...
                    <Col>
                      <Dropdown onSelect={this.handleOnSelect}>
                        ...
                        <Dropdown.Menu name="gender" value={formState.gender}>
                          <Dropdown.Item href="#/action-1" name="female">
                            Female
                          </Dropdown.Item>
                          <Dropdown.Item href="#/action-2" name="male">
                            Male
                          </Dropdown.Item>
                          <Dropdown.Item href="#/action-3" name="other">
                            Other
                          </Dropdown.Item>
                        </Dropdown.Menu>
                      </Dropdown>
                      ...
                      <div className="flex">
                        <span>
                          <button
                            ...
                            onClick={() =>
                              this.handleShowModalEdit(user.userId)
                            }
                          >
                ...
                <Row className="mb-3">
                  <Form.Group as={Col} controlId="formGridFirstName">
                    ...
                    <Form.Control
                      ...
                      value={formState.firstname}
                      name="firstname"
                      defaultValue={this.state.editUsers.firstname}
                  ...
                  <Form.Group as={Col} controlId="formGridLastName">
                    ...
                    <Form.Control
                      ...
                      placeholder="Enter lastname"
                      value={formState.lastname}
                      defaultValue={this.state.editUsers.lastname}
                      name="lastname"
                      onChange={this.handleOnChangeEdit}
                    />
                  </Form.Group>
